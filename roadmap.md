...
- [ ] A2P 10DLC compliance: src/lib/legal-identity.ts, /privacy, /terms, SmsConsent component, wire into /audit /book /brief + endpoints + DB columns, footer links, sitemap, publish
