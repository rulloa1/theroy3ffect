...
const interactiveElements = 'a, button, input, select, textarea, .project, .service, .tag, .faq__question, .process__card, .testimonial-card';
...
const projectData = {
  apex: {
    ...
    year: '2024',
    deliverables: 'Identity System, Custom Typography, Luxury Packaging, Print Collateral, Brand Guidelines',
    challenge: 'Apex was operating with an outdated visual language that failed to command luxury price points in a competitive luxury direct-to-consumer landscape.',
    solution: 'Engineered a stark, minimalist visual identity anchored by bespoke debossed typography, warm gold foil accents on tactile matte stocks, and a modern scalable digital design system.',
    impact: '+340% increase in average order value and featured across top design publications within 60 days of relaunch.'
  },
  editorial: {
    ...
    challenge: 'Creating a hauntingly elegant editorial photo essay to launch an avant-garde eveningwear collection without relying on predictable runway motifs.',
    solution: 'Deployed dramatic chiaroscuro studio lighting, moody atmospheric haze, and dynamic camera angles to emphasize rich garment silhouettes and tactile fabrics.',
    impact: 'Syndicated across 3 major digital fashion publications and drove an immediate collection sell-out.'
  },
  social: {
    ...
    year: '2024',
    deliverables: 'Social Media Strategy, 40+ Short-form Video Assets, Motion Templates, Visual Content Guidelines',
    challenge: 'Re-energizing a performance brand on TikTok and Instagram to attract a younger demographic accustomed to ultra-fast visual editing.',
    solution: 'Produced a cohesive 60-day visual rollout blending high-octane macro photography, kinetic typography, and pulse-driven motion design.',
    impact: 'Generated 2.4M organic impressions, 45,000+ new followers, and a 220% lift in engagement rate.'
  },
  lookbook: {
    ...
    challenge: 'Designing a collectible, limited-run print monograph that serves as both a seasonal lookbook and a coffee table art piece.',
    solution: 'Curated 120 pages of archival Japanese paper, raw exposed thread binding, and minimalist Swiss grid typography to highlight collection details.',
    impact: 'Exhibited at independent publishing fairs and served as a high-conversion sales tool for VIP buyers.'
  },
  'brand-system': {
    ...
    year: '2023–2024',
    deliverables: 'Master Brand Book, UI Design Tokens, Corporate Deck Systems, Exhibition Architecture',
    challenge: 'Consolidating 4 disparate sub-brands under one authoritative, modern umbrella without losing existing brand equity.',
    solution: 'Constructed an adaptive design matrix featuring variable logotypes, modular grids, and clear governance rules for internal teams.',
...
contactForm.addEventListener('submit', function (e) {
  ...
  if (!messageInput.value.trim() || messageInput.value.trim().length < 10) {
    messageError.textContent = 'Please include details about your project (at least 10 characters).';
