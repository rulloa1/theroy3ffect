...
export function CinematicHomepage() {
  ...
  return (
    <main id="top" className="cinematic-home">
      ...
      <section id="contact" className="cinematic-section cinematic-wrap contact-section"><div className="contact-grid"><CinematicReveal className="contact-copy"><span className="cinematic-label">Let&apos;s work</span><h2>Tell me about the business. I&apos;ll show you the site.</h2><p>Send a few lines and I&apos;ll come back within one business day — or book a free discovery call directly.</p><div className="direct-links"><Link to="/book"><span>Book a discovery call</span><small>15 min · free</small></Link><a href="mailto:rory@theroyeffect.com"><span>Email</span><small>rory@theroyeffect.com</small></a><a href="tel:+12813230450"><span>Call or text</span><small>(281) 323-0450</small></a></div></CinematicReveal><CinematicReveal><ContactForm /></CinematicReveal></div></section>
